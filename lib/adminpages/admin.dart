...
import 'package:prj1/adminpages/admsearch.dart';
...
class _AdminLoginState extends State<Admin> {
  ...
  final TextEditingController _festivalEditingController =
      TextEditingController();
  final TextEditingController _latestEditingController =
      TextEditingController();
            ...
            child: Form(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        controller: _festivalEditingController,
                        decoration: InputDecoration(
                          labelText: 'festival related',
                          fillColor: const Color.fromARGB(255, 255, 255, 255),
                          hintText: "festival related",
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(25.0),
                          ),
                        ),
                      ...
                      TextFormField(
                        controller: _latestEditingController,
                        decoration: InputDecoration(
                          labelText: 'latest',
                          fillColor: const Color.fromARGB(255, 255, 255, 255),
                          hintText: "latest",
                                ...
                                if (formkey.currentState!.validate()) {
                                  if (selectImage == null) {
                                    ...
                                    final variableReceipes = Recipe(
                                      ...
                                      category: _categEditingController.text,
                                      festivalrelated:
                                          _festivalEditingController.text,
                                      latest: _latestEditingController.text,
                                    ...
                                    _festivalEditingController.clear();
                                    _latestEditingController.clear();
